<?php $__env->startSection('title', 'Patient Dashboard - MediCare Chat'); ?>
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text display-4">1</p>
                    <p class="text-muted">
                        <a href="<?php echo e(route('patient.chat')); ?>">View messages</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects Laravel\laravel-chat\laravel-chat\resources\views/patient/dashboard.blade.php ENDPATH**/ ?>